...
import { processorGroupSelectionForCloudService } from "./services/nvsk-api/processorGroup.service";
...
@Module({
  ...
  providers: [
    ...
    GrammarService,
    ValidatorService,
    processorGroupSelectionForCloudService
  ],
